...
resource "aws_redshift_cluster_iam_roles" "rc_iamroles" {
  cluster_identifier = aws_redshift_cluster.pocnrt_rc.cluster_identifier
  iam_role_arns      = [aws_iam_role.poc_nrt_role.arn]
}